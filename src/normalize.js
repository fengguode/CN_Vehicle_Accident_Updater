...
export function normalizeReport(input, source = {}) {
  ...
  return {
    ...
    title,
    title_en: normalizeText(input.title_en) || null,
    content,
    content_en: normalizeText(input.content_en) || null,
    ...
    ...labels,
    adas_mode: input.adas_mode || labels.adas_mode,
    road_type: input.road_type || labels.road_type,
    province: input.province || labels.province,
