...
const reports = rows.map((row) => ({
  ...
  platform: row.platform, title: row.title, title_en: englishTitle(row), content: row.content, author: row.author,
  ...
  english_description: row.english_description || englishDescription(row), description_en: row.english_description || englishDescription(row), english_description_source: row.english_description_source || 'machine_heuristic_v1'
}));
